// const pageDown = document.querySelector(".fa-arrow-down");

// pageDown.addEventListener("click", () => {
//   document.querySelector("#filter-btn").scrollIntoView({ behavior: 'smooth' });
// });
...
{
    var elem = document.getElementById("filter-btn");
    if (elem.value=="HIDE FILTER") elem.value = "SHOW FILTER";
    else elem.value = "HIDE FILTER";
}
